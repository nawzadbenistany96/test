...
<div class="container">
    ...
    <div class="row">
        ...
        <!-- Display Details -->
        <div class="col-md-6">
            <form method="post" action="{{ route('addLaptops') }}">
                @csrf
                <table class="table table-dark">
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="form-group">
                                    <span style="font-size: 17px;font-weight: bold;">{{ __('CPU') }} : </span>
                                    &nbsp
                                    <span style="font-size: 15px">{{ $product->cpu }}</span>
                                </div>
                            </td>
                        </tr>
                        ...
                        <tr>
                            <!-- RAM  -->
                            <td>
                                <span style="font-size: 20px;font-weight: bold;">{{ __('RAM') }} : </span>
                                &nbsp
                                <span style="font-size: 15px">{{ $product->ram }}</span>
                            </td>
                            <!-- Laptop Processor  -->
                            <td>
                                <div class="form-group">
                                    <span style="font-size: 20px;font-weight: bold;">{{ __('Processor') }} : </span>

                                    <span style="font-size: 15px">{{ $product->processor }}</span>
                                </div>
                            </td>
                        </tr>
                        ...
                        <tr>
                            <!-- Touch Screen  -->
                            <td>
                                <span style="font-size: 20px;font-weight: bold;">{{ __('Touch Screen') }} : </span>
                                &nbsp
                                <span style="font-size: 15px">{{ $product->touch_screen }}</span>
                            </td>
                            <!-- Laptop Brand  -->
                            <td>
                                <div class="form-group">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="form-group">
                                    ...
                                    <span style="font-size: 15px">{{ $product->hardsize }}</span>
                                </div>
                            </td>
                        </tr>

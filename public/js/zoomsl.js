    ...
    $.extend(sergelandimagezoomer, {
        ...
        controlLoop2: function ($tracker) {
            ...
            specs.$bigimage.css({
                width: Math.round(
                    specs.currM *
                        specs.bigimage.w *
                        (specs.img.w / specs.bigimage.w)
                ),
                height: Math.round(
                    specs.currM *
                        specs.bigimage.h *
                        (specs.img.h / specs.bigimage.h)
                ),
            });
        ...
        init: function ($img, options, gallery) {
                ...
                $tracker.data("specs", {
                    ...
                    cursorshade999: {
                        ...
                        border999: {
                            left999:
                                parseInt(
                                    $cursorshade.css("border-left-width")
                                ) || 0,
                            top999:
                                parseInt(
                                    $cursorshade.css("border-top-width")
                                ) || 0,
                        },
                    },
            ...
            if (setting.cursorshade) {
                $cursorshade
                    ...
                    .css({
                        ...
                        position: "absolute",
                        width: Math.round(
                            setting.magnifiersize[0] / setting.zoomstart
                        ),
                        height: Math.round(
            ...
            $tracker.mouseover(function (e) {
                ...
                setting.largeimage =
                    $img.attr("data-large") || $img.attr("src");
            ...
            $tracker.one("mouseover", function (e) {
                ...
                if (!self.loaded999[setting.largeimage]) {
                    ...
                    $statusdiv.css({
                        left:
                            imgcoords.left + img.w / 2 - $statusdiv.width() / 2,
                        top:
                            imgcoords.top + img.h / 2 - $statusdiv.height() / 2,
                        visibility: "visible",
                    });
                }
